...
# print "Total amount of time (seconds): " + str(total_seconds)
# print "Total amount of messages: " + str(message_count)
# print "Messages per second: " + str(messages_per_second)
